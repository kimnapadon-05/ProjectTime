...
function loadPersonTable(page, search = '') {
    ...
    $.ajax({
        url: window.PROJECT_ROOT + '/backend/person_handler.php', 
        method: 'POST', 
        data: { 
            action: 'read', 
            page: page, 
...
function loadPositions() {
    $.ajax({
        url: window.PROJECT_ROOT + '/backend/person_handler.php', method: 'POST', data: { action: 'get_positions' }, dataType: 'json',
...
function savePerson() {
    $.ajax({
        url: window.PROJECT_ROOT + '/backend/person_handler.php', method: 'POST', data: $('#personForm').serialize(), dataType: 'json',
        success: function(res) {
...
function deletePerson(id) {
    Swal.fire({
        ...
        if(r.isConfirmed) {
            $.post(window.PROJECT_ROOT + '/backend/person_handler.php', { action: 'delete', person_id: id }, function(res) {
                if(res.status === 'success') {
                    loadPersonTable(currentPage);
