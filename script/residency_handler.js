...
$(document).ready(function() {
    ...
    $('#house_select').change(function() {
        ...
        if (houseId) {
            $.ajax({
                url: window.PROJECT_ROOT + '/backend/residency_handler.php',
                method: 'POST',
...
function loadFormData() {
    $.ajax({
        url: window.PROJECT_ROOT + '/backend/residency_handler.php', method: 'POST', data: { action: 'get_form_data' }, dataType: 'json',
        success: function(res) {
...
function saveMoveIn() {
    ...
    $.ajax({
        url: window.PROJECT_ROOT + '/backend/residency_handler.php', method: 'POST', data: $('#moveInForm').serialize(), dataType: 'json',
        success: function(res) {
...
function saveMoveOut() {
    ...
    $.ajax({
        url: window.PROJECT_ROOT + '/backend/residency_handler.php', method: 'POST', data: $('#moveOutForm').serialize(), dataType: 'json',
        success: function(res) {
            if(res.status == 'success') {
